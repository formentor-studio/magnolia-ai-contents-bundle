...
import org.formentor.magnolia.ai.training.AiTrainingModule;
import org.formentor.magnolia.ai.training.domain.AiModel;
import org.formentor.magnolia.ai.training.domain.Dataset;
import org.formentor.magnolia.ai.training.infrastructure.openai.dto.FineTuneRequest;
import org.formentor.magnolia.ai.training.infrastructure.openai.dto.FineTuneResult;
...
public class AiModelOpenAI implements AiModel {
    ...
    protected CompletableFuture<java.io.File> prepareDataset(Dataset dataset) throws IOException {
