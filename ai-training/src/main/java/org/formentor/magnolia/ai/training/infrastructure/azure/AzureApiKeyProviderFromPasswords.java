 ...
 */
@Slf4j
public class AzureApiKeyProviderFromPasswords implements AzureApiKeyProvider {
    ...
    @Inject
    public AzureApiKeyProviderFromPasswords(PasswordRegistry passwordRegistry, SystemContext systemContext) {
